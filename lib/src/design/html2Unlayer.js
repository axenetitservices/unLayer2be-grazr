...
class Html2Unlayer {
    ...
    constructor(data) {
        ...
        this.hasMultipleCell = (columns) => {
            const cells = columns === null || columns === void 0 ? void 0 : columns.map((x) => {
                ...
                return (_a = Array.from((0, htmlParser_1.parseChildren)(x.children))) === null || _a === void 0 ? void 0 : _a.map((y) => {
                    var _a, _b;
                    return y.classList.contains("unlayer2be")
                        ? -1
                        : Number((_b = ((_a = y === null || y === void 0 ? void 0 : y.style["min-width"]) !== null && _a !== void 0 ? _a : y === null || y === void 0 ? void 0 : y.style["width"])) === null || _b === void 0 ? void 0 : _b.replace(/[a-zA-Z]+/g, ""));
                });
            });
            return cells ? (cells.length > 0 ? cells[0].length > 1 : false) : false;
        };
        this.getColumns = (columns) => Array.from(columns).map((column, i) => {
            ...
            const padding = Array.from((0, htmlParser_1.parseChildren)(column.children, true))[0]
                .parentElement.parentElement.style["padding"];
        ...
        this.calculateColumnsRatio = (cells) => {
            return (cells === null || cells === void 0 ? void 0 : cells.includes(-1))
                ? [12]
                : (cells === null || cells === void 0 ? void 0 : cells.length)
                    ? cells === null || cells === void 0 ? void 0 : cells.map((x) => !isNaN(x) && x
                        ? Math.round(x / Math.min(...cells.map((y) => (y == 0 ? 1 : y))))
                        : 12)
                    : [12];
        };
        ...
        this.getImage = (content) => {
            ...
            return Object.assign({}, {
                src: {
                    ...
                    width: ((_b = content === null || content === void 0 ? void 0 : content.querySelector("img")) === null || _b === void 0 ? void 0 : _b.width)
                        ? (_c = content === null || content === void 0 ? void 0 : content.querySelector("img")) === null || _c === void 0 ? void 0 : _c.width
                        : "auto",
                    height: ((_d = content === null || content === void 0 ? void 0 : content.querySelector("img")) === null || _d === void 0 ? void 0 : _d.height)
                        ? (_e = content === null || content === void 0 ? void 0 : content.querySelector("img")) === null || _e === void 0 ? void 0 : _e.height
                        : "auto",
                },
            });
        };
         ...
         */
        this.getStyle = (style, text = "", id_type) => style
            ? Object.assign({}, {
                ...
                size: {
                    autoWidth: true,
                    width: (style === null || style === void 0 ? void 0 : style.width) != "" && (style === null || style === void 0 ? void 0 : style.width) != null
                        ? style.width
                        : style["min-width"],
                },
